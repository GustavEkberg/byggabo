...
export function LandingPage({ isSweden = false }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      {/* Event Log Demo */}
      <section className="flex min-h-dvh items-center px-4 py-16 sm:py-24">
      ...
      <section
        id="features"
        className="flex min-h-dvh items-center px-4 py-16 sm:py-24 bg-muted/30"
      >
      ...
      {/* How it works */}
      <section id="how-it-works" className="flex min-h-dvh items-center px-4 py-16 sm:py-24">
        <div className="mx-auto max-w-4xl">
          <div className="mb-12 text-center">
      ...
      <div className="flex justify-center px-4 pb-6">
        <a
          href="https://github.com/GustavEkberg/byggabo"
          target="_blank"
